...
<div class="wrap erb-admin-page">
    <h1><?php esc_html_e( 'Customers', 'escape-room-booking' ); ?></h1>
    ...
    <div class="erb-card" style="margin-bottom:1rem;">
        <form method="get" action="" style="display:flex;gap:.75rem;align-items:flex-end;flex-wrap:wrap;">
            ...
            <div class="erb-form-group" style="min-width:auto;">
                <label>&nbsp;</label>
                <button type="submit" class="erb-btn erb-btn--primary erb-btn--auto"><?php esc_html_e( 'Search', 'escape-room-booking' ); ?></button>
            </div>
            <?php if ( $search ) : ?>
            <div class="erb-form-group" style="min-width:auto;">
                <label>&nbsp;</label>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=erb-customers' ) ); ?>" class="erb-btn erb-btn--outline erb-btn--auto"><?php esc_html_e( 'Clear', 'escape-room-booking' ); ?></a>
            </div>
            <?php endif; ?>
        </form>
    </div>
    ...
    <div class="erb-card">
        ...
        <table class="erb-table" style="font-size:.875rem;">
            <thead><tr>
                <th><?php esc_html_e( 'Name', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Email', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Mobile', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Type', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Bookings', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Total Spent', 'escape-room-booking' ); ?></th>
                <th><?php esc_html_e( 'Joined', 'escape-room-booking' ); ?></th>
            </tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="erb-badge <?php echo $c->is_guest ? 'erb-badge--pending' : 'erb-badge--confirmed'; ?>">
                            <?php echo $c->is_guest ? esc_html__( 'Guest', 'escape-room-booking' ) : esc_html__( 'Account', 'escape-room-booking' ); ?>
                        </span>
                    </td>
