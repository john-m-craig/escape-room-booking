...
<div class="wrap erb-admin-page">
    <h1><?php esc_html_e( 'Bookings', 'ettrick-escape-room-booking' ); ?></h1>
    ...
    <div class="erb-card" style="margin-bottom:1rem;">
        <form method="get" action="" style="display:flex;flex-wrap:wrap;gap:.75rem;align-items:flex-end;">
            ...
            <div class="erb-form-group">
                ...
                <select name="status">
                    <option value=""><?php esc_html_e( 'All statuses', 'ettrick-escape-room-booking' ); ?></option>
            ...
            <div class="erb-form-group">
                <label><?php esc_html_e( 'Game', 'ettrick-escape-room-booking' ); ?></label>
                <select name="game_id">
                    <option value=""><?php esc_html_e( 'All games', 'ettrick-escape-room-booking' ); ?></option>
            ...
            <div class="erb-form-group" style="min-width:auto;">
                <label>&nbsp;</label>
                <button type="submit" class="erb-btn erb-btn--primary erb-btn--auto"><?php esc_html_e( 'Filter', 'ettrick-escape-room-booking' ); ?></button>
            </div>
    ...
    <div class="erb-card">
        <h2>
            ...
            printf( esc_html__( '%d booking(s)', 'ettrick-escape-room-booking' ), count( $bookings ) ); ?>
        ...
        <?php if ( empty( $bookings ) ) : ?>
            <p><em><?php esc_html_e( 'No bookings found.', 'ettrick-escape-room-booking' ); ?></em></p>
        <?php else : ?>
        <table class="erb-table" style="font-size:.875rem;">
            <thead><tr>
                ...
                <th><?php esc_html_e( 'Date & Time', 'ettrick-escape-room-booking' ); ?></th>
...
<div class="erb-modal-overlay" id="erb-booking-modal">
    <div class="erb-modal" style="max-width:560px;">
        ...
        <h2 id="erb-booking-modal-title"><?php esc_html_e( 'Booking Details', 'ettrick-escape-room-booking' ); ?></h2>
